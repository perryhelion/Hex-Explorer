...
UBUNTU_TRANSLATION_DOMAIN="hexexplorer.phelion"
...
aptest.commands = bash $$PWD/HexExplorer/tests/autopilot/run
aptest.depends  = sub-HexExplorer

unittest.target   = check
unittest.commands = /usr/bin/qmltestrunner -input $$PWD/HexExplorer/tests/unit 
unittest.depends  = sub-HexExplorer
