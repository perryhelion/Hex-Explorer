...
MainView {
    ...
    property string defaultpagecolour: UbuntuColors.darkAubergine

        property string pagecolour : defaultpagecolour
        property string dividecolour: Qt.darker(pagecolour)
